...
?>
	...
	<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
		...
		<div class="container">
			...
			<?php echo apply_filters( 'llorix_one_plus_footer_text_filter', '<div class="powered-by">copyright<p></a>' . esc_html__( 'by', 'llorix-one-lite' ) . ' ' . esc_html__( 'vAMW', 'llorix-one-lite' ) . '</a></div>' ); ?>
