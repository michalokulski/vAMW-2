...
if exist C:\xampp1\jboss\scripts\ctl.bat (start /MIN /B C:\xampp1\jboss\scripts\ctl.bat START)
...
if exist C:\xampp1\jboss\scripts\ctl.bat (start /MIN /B C:\xampp1\jboss\scripts\ctl.bat STOP)
